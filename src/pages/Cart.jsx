    ...
    <div className="border-t pt-14">
      ...
      <div>
        {cartData.map((item, index) => {
          // Correct the find method: use `product._id` instead of `Product._id`
          const productData = products.find((product) => product._id === item._id);

          // Handle cases where productData might be undefined
          ...
          return (
            ...
            >
              <div className="flex items-start gap-6">
                {/* Use optional chaining to avoid errors if image is undefined */}
                <img
